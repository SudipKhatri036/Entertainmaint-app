...
function ExtraDetail({ data }) {
  ...
  return (
    <div className="grid grid-cols-2 xs:flex justify-between items-center">
      {!isTv && (
        <div>
          <p className="text-prime-300 text-lg md:text-2xl mb-4">Length</p>
      ...
      {isTv && (
        <div>
          <p className="text-prime-300 text-lg md:text-2xl mb-4">First Air</p>
          <p className="text-sm md:text-md tracking-wide uppercase">
            {data?.first_air_date}
          </p>
        </div>
      ...
      <div>
        <p className="text-prime-300 text-lg md:text-2xl mb-4">
          {isTv ? "Last Air" : "Year"}
        </p>
        <p className="text-sm md:text-md tracking-wide">
      ...
      <div>
        <p className="text-prime-300 text-lg md:text-2xl mb-4">Status</p>
        <p className="text-sm md:text-md tracking-wide">
          {data?.status || "N/A"}
        </p>
      </div>
